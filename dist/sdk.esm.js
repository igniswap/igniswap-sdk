...
import IIgniPair from '@igniswap/igni-swap-core/build/IIgniPair.json';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IIgniPair.abi, provider).getReserves()).then(function (_ref) {
