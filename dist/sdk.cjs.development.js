...
var IIgniPair = _interopDefault(require('@igniswap/igni-swap-core/build/IIgniPair.json'));
...
var FACTORY_ADDRESS = '0x5f76c63aAcA37ABDBcbFF0Ce67A1b8560ACDcbE7';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IIgniPair.abi, provider).getReserves()).then(function (_ref) {
